...
<%--<c:choose>
    <c:when test="${!empty loggedUser}">
        <c:out value="${loggedUser.firstname}" />&nbsp;&nbsp;&nbsp;<a href="<c:url value="j_spring_security_logout" />" > Logout</a>
    </c:when>
    <c:otherwise>
        <a href="/business/signup"> A Business Owner?</a>&nbsp;
        <a href="login"><font color="#FFFFFF"><span class="uline">  Login </span></font></a> &nbsp;&nbsp;
        <a href="signup"><font color="#FFFFFF"><span class="uline">  Sign Up! </span></font></a>
    </c:otherwise>
</c:choose>--%>
</div>
</div>-->
...
<div id="header">
    <div id="headercontent" class="center">
        <c:choose>
            ...
            <c:otherwise>
                <a href="/business/signup"><font color="#FFFFFF"><span class="uline"> A Business Owner?</span></font></a>&nbsp;
                <a href="login"><font color="#FFFFFF"><span class="uline">  Login </span></font></a> &nbsp;&nbsp;
                <a href="signup"><font color="#FFFFFF"><span class="uline">  Sign Up! </span></font></a>
                </c:otherwise>
            </c:choose>
    ...
    <div id="logo">
        <heading><a href="/index">TiMe<fontLogo>4</fontLogo>HoBbY</a><div id="alignlogo" ></div></heading>x
    </div>
</div>
